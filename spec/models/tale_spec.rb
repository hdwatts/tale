...
RSpec.describe Tale, type: :model do
  ...
  let (:tale) { Tale.create!(title: "My Title", prompt: "Now I am telling a story let me tell you", owner_id: user.id, lines_attributes: {"0"=> {content: "this is the first line", user_id: user.id, done: true}}) }
